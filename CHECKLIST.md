...
|---|---|---|---|---|
| G1, the gate runner | `planning/plans/packages/G1-gate-runner.md` | done, awaiting merge | `pkg/G1` | `pytest tools/tests/test_gates.py` exits 0, and `python tools/gates.py --package G1 --allowed "tools/,gates-log/,CHECKLIST.md"` exits 0 |
