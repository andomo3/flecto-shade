<!-- Extracted from `HackMit ;p.md` lines 7676 to 8105 by scripts/extract_playbook.py. Edit the playbook, not this file. -->
...
**5 minutes before:**
 ...
 2. Review your demo script
 3. Have a backup plan
 4. Test audio/video if applicable
